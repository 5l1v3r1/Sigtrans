              ...
              <Tabs defaultActiveKey={1} id="event-form-tabs">
                <Tab eventKey={1} title="Geral">
                  <General
                    ...
                    cruzamentos={this.props.cruzamentos}
                    onChangeInput={this.props.onChangeInput}
                    onChangeDropdown={this.props.onChangeDropdown}
                    onNestedInputChange={this.props.onNestedInputChange}
                    asyncTypeaheadQuery={this.props.asyncTypeaheadQuery}
                ...
                <Tab eventKey={2} title="Dados Estatisticos">
                  <StatisticData
                    ...
                    onChangeDropdown={this.props.onChangeDropdown}
                    onChangeInput={this.props.onChangeInput}
                    add={this.props.addVia}
                    remove={this.props.removeVia}
                    subMenu="dadosEstatisticos"
                  />
                </Tab>
                <Tab eventKey={3} title="Veículos">
                  <br />
                  <Button label="Adicionar" onClick={() => this.props.addVehicle()} />
                  <Vehicles
                ...
                <Tab eventKey={4} title="Envolvidos">
                  <br />
                  <Button label="Adicionar" onClick={() => this.props.addInvolved()} />
                  <Involved
                ...
                <Tab eventKey={5} title="Informações Adicionais">
                  <Row>
                    ...
                    <Col md={12}>
                      <Input
                        value={this.props.selectedEvent ? this.props.selectedEvent.dadosGerais.informacoesAdicionais || '' : ''}
                        style={{ height: '200px' }}
...
class General extends Component {
  render() {
    const mapCenter = this.props.data.latitude ? {
    ...
    this.ruas = this.props.ruas || [this.props.data.rua] || [];
    this.cruzamentos = this.props.cruzamentos || [this.props.data.cruzamento] || [];
    ...
    return (
      <Row className="form-group">
        ...
        <Col md={4}>
          <Input
            value={this.props.data.dataHora || ''}
            type="datetime-local"
            id="dataHora"
            label="Data"
        ...
        <Col md={2}>
          <Select
            value={this.props.data.estado ? this.props.data.estado.id : ''}
            id="estado"
            name="estado"
        ...
        <Col md={3}>
          ...
          <AsyncTypeahead
            ...
            isLoading={this.props.municipioIsLoading === true}
            onSearch={(query) => {
              this.props.asyncTypeaheadQuery(query, 'municipio', this.props.data.estado, 'estado');
            }}
            options={this.props.municipios ? this.props.municipios : this.props.data.municipio ? [this.props.data.municipio] : []}
            selected={this.props.data.municipio ? [this.props.data.municipio] : undefined}
            searchText="Procurando..."
            promptText="Municipio"
            id="municipio"
            className="form-group"
            onChange={(selected) => {
              if (selected[0]) {
                this.props.fetchDependentOptions(selected[0], 'bairro');
                this.props.onChangeInput(selected[0], 'municipio', this.props.subMenu);
              }
            }}
          />
        </Col>
        ...
        <Col md={4}>
          ...
          <AsyncTypeahead
            ...
            options={this.ruas}
            selected={this.props.data.rua ? [this.props.data.rua] : undefined}
            searchText="Procurando..."
            promptText="Rua"
            id="rua"
            className="form-group"
            onChange={(selected) => {
              if (selected[0]) {
                this.props.onChangeInput(selected[0], 'rua', this.props.subMenu);
              }
            }}
          />
        </Col>
        ...
        <Col md={2}>
          <Select
            value={this.props.data.bairro ? this.props.data.bairro.id : ''}
            id="bairro"
            name="bairro"
            onChange={e => this.props.onChangeDropdown(e.target.value, e.target.id, this.props.subMenu)}
        ...
        <Col md={4}>
          ...
          <AsyncTypeahead
            ...
            searchText="Procurando..."
            promptText="Cruzamento"
            id="municipio"
            className="form-group"
            onChange={(selected) => {
              if (selected[0]) {
                this.props.onChangeInput(selected[0], 'cruzamento', this.props.subMenu);
              }
            }}
          />
        </Col>
      ...
      <Row className="form-group">
        ...
        <Col md={12}>
          <Row>
            ...
            <Col md={3}>
              <Select
                value={this.props.data.acidenteTrabalho ? this.props.data.acidenteTrabalho.id : ''}
                id="acidenteTrabalho"
            ...
            <Col md={3}>
              <Select
                value={this.props.data.tipoAcidente ? this.props.data.tipoAcidente.id : ''}
                id="tipoAcidente"
                name="tipoAcidente"
                onChange={e => this.props.onChangeDropdown(e.target.value, e.target.id, this.props.subMenu)}
            ...
            <Col md={3}>
              <Select
                value={this.props.data.classificacaoAcidente ? this.props.data.classificacaoAcidente.id : ''}
                id="classificacaoAcidente"
                name="classificacaoAcidente"
                onChange={e => this.props.onChangeDropdown(e.target.value, e.target.id, this.props.subMenu)}
                          ...
                          <Row>
                            <Col md={10}>
                              <Row>
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.tipoVia ? via.tipoVia.id : ''}
                                    id="tipoVia"
                                    name="tipoVia"
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.pavimentacao ? via.pavimentacao.id : ''}
                                    id="pavimentacao"
                                    name="pavimentacao"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.conservacaoVia ? via.conservacaoVia.id : ''}
                                    id="conservacaoVia"
                                    name="conservacaoVia"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.sentidoVia ? via.sentidoVia.id : ''}
                                    id="sentidoVia"
                                    name="sentidoVia"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.semaforo ? via.semaforo.id : ''}
                                    id="semaforo"
                                    name="semaforo"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.perfilPista ? via.perfilPista.id : ''}
                                    id="perfilPista"
                                    name="perfilPista"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.superficie ? via.superficie.id : ''}
                                    id="superficie"
                                    name="superficie"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.condicaoClimatica ? via.condicaoClimatica.id : ''}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.equipamentoControleTrafego ? via.equipamentoControleTrafego.id : ''}
                                    id="equipamentoControleTrafego"
                                    name="equipamentoControleTrafego"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.separacaoPista ? via.separacaoPista.id : ''}
                                    id="separacaoPista"
                                    name="separacaoPista"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.visibilidade ? via.visibilidade.id : ''}
                                    id="visibilidade"
                                    name="visibilidade"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.condicaoTecnica ? via.condicaoTecnica.id : ''}
                                    id="condicaoTecnica"
                                    name="condicaoTecnica"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.acostamento ? via.acostamento.id : ''}
                                    id="acostamento"
                                    name="acostamento"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.sinalizacao ? via.sinalizacao.id : ''}
                                    id="sinalizacao"
                                    name="sinalizacao"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                                ...
                                <Col md={3}>
                                  <Select
                                    value={via.sinaisPneus ? via.sinaisPneus.id : ''}
                                    id="sinaisPneus"
                                    name="sinaisPneus"
                                    onChange={e => this.props.onNestedInputChange(this.props.subMenu, 'vias', e.target.id, via, e.target.value, 'id')}
                            ...
                            <Col md={2}>
                              <Button icon="close" onClick={() => this.props.remove(via)}> Remover </Button>
                            </Col>
                          </Row>
                        </AccordionItem>
                      );
          ...
          <Accordion allowMultiple>
            {
              this.props.data ? this.props.data.map((vehicle) => {
                const eventKey = vehicle.id ? vehicle.id : i++;
                const header = vehicle.placa ? vehicle.placa : '';
                return (
                    ...
                    <Row>
                      <Col md={10}>
                        <Row>
                          ...
                          <Col md={4}>
                            <Select
                              value={vehicle.marca ? vehicle.marca.id : ''}
                              id="marca"
                              name="marca"
                              required="required"
                              label="Marca"
                          ...
                          <Col md={4}>
                            <Select
                              value={vehicle.modelo ? vehicle.modelo.id : ''}
                              id="modelo"
                              name="modelo"
                              required="required"
                              label="Modelo"
                          ...
                          <Col md={4}>
                            <Select
                              value={vehicle.categoriaVeiculo ? vehicle.categoriaVeiculo.id : ''}
                              id="categoriaVeiculo"
                        ...
                        <Row>
                          ...
                          <Col md={4}>
                            <Input
                              value={vehicle.condutor ? vehicle.condutor.nome : ''}
                              type="text"
                              id="nome"
                          ...
                          <Col md={3}>
                            <Input
                              value={vehicle.condutor ? vehicle.condutor.cnh : ''}
                              type="number"
                              id="cnh"
                          ...
                          <Col md={3}>
                            <Input
                              value={vehicle.condutor ? vehicle.condutor.validadeCNH : ''}
                              type="date"
                              id="validadeCNH"
                      ...
                      <Col md={2}>
                        <Button icon="close" onClick={() => this.props.remove(vehicle)}>Remover</Button>
                      </Col>
                    </Row>
                  </AccordionItem>
                );
          ...
          <Accordion allowMultiple>
            {
              this.props.data ? this.props.data.map((involved) => {
                const header = involved.nome ? involved.nome : '';
                const eventKey = involved.id ? involved.id : i++;
                return (
                    ...
                    <Row>
                      <Col md={10}>
                        ...
                        <Row>
                          <Col md={4}>
                            <Select
                              value={involved.estado ? involved.estado.id : ''}
                              id="estado"
                              name="estado"
                          ...
                          <Col md={4}>
                            <Select
                              value={involved.municipio ? involved.municipio.id : ''}
                              id="municipio"
                              name="municipio"
                          ...
                          <Col md={4}>
                            <Select
                              value={involved.rua ? involved.rua.id : ''}
                              id="rua"
                              name="rua"
                              label="Rua"
                        ...
                        <Row>
                          <Col md={4}>
                            <Select
                              value={involved.grauInstrucao ? involved.grauInstrucao.id : ''}
                              id="grauInstrucao"
                              name="grauInstrucao"
                          ...
                          <Col md={4}>
                            <Select
                              value={involved.profissao ? involved.profissao.id : ''}
                              id="profissao"
                              name="profissao"
                              label="Profissão"
                        ...
                        <Row>
                          <Col md={4}>
                            <Select
                              value={involved.veiculo ? involved.veiculo.id : ''}
                              id="veiculo"
                              name="veiculo"
                              label="Veiculo"
                          ...
                          <Col md={4}>
                            <Select
                              value={involved.posicaoVeiculo ? involved.posicaoVeiculo.id : ''}
                              id="posicaoVeiculo"
                              name="posicaoVeiculo"
                          ...
                          <Col md={4}>
                            <Select
                              value={involved.condicaoSeguranca ? involved.condicaoSeguranca.id : ''}
                        ...
                        </Row>
                        {
                          involved.lesao || involved.localEncaminhado || involved.aih ? (
                            <Row>
                              <Col md={4}>
                                <Select
                                  value={involved.lesao ? involved.lesao.id : ''}
                                  id="lesao"
                                  name="lesao"
                              ...
                              <Col md={4}>
                                <Select
                                  value={involved.localEncaminhado ? involved.localEncaminhado.id : ''}
                                  id="localEncaminhado"
                                  name="localEncaminhado"
                      ...
                      <Col md={2}>
                        <Button
                          icon="close"
                          onClick={() => this.props.remove(involved)}
                        >
                          Remover
                        </Button>
                      </Col>
